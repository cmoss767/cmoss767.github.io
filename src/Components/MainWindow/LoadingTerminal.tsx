...
const LoadingTerminal = () => {
  ...
  return (
    <div className="bg-[#f9efe4] h-[calc(100vh-200px)] md:h-[375px] w-full border-3 border-black p-2 overflow-auto">
      {showText.text1 && (
      ...
      {showText.greetingText && (
        <div className="text-center p-4">
          <h2 className="text-2xl md:text-4xl">Hi there, I'm Chris. 👋 </h2>
          <span className="text-xl md:text-2xl">Welcome to my Site</span>
        </div>
      )}
      {showText.terminal && (
        <>
          <div className="mt-2 ">
            <span className="text-xl block">Need Help?</span>
